    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        if(commandSender instanceof Player) {
            if(strings.length == 0) {
                ...
                GameFrom simple = new GameFrom("§c空岛§b战争",
                        "出生在仅有你一人的空中小岛，在小岛上寻找你的初级装备，\n"+
                                "搭建道路到藏有高级装备的大岛，击败和你一样探险的玩家。\n" +
                                "形单影只面临所有玩家的威胁，你能成为活到最后的一个的人吗？\n" +
                                "冒险和击杀尽在空岛战争：挑战你生存极限的玩家对战小游戏。", DisPlayWindowsFrom.getId(51530, 99810));
                ...
                for (String wname : TotalManager.getMenuRoomManager().getNames()) {
                    ...
                    simple.add(new BaseIButton(new ElementButton(TextFormat.colorize('&', "&c空岛&b战争 &r- &l&5"+wname+" \n&r\uE175 "+size))) {
                        @Override
                        public void onClick(Player player) {
